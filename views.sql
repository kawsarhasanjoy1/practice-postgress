...
INSERT INTO workers (employe_name, employe_salary, department_name, hire_date) VALUES
...
CREATE VIEW dep_avg_salary AS SELECT department_name ,AVG(employe_salary) FROM workers GROUP BY department_name;
